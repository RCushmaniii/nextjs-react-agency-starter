...
export const metadata: Metadata = {
  title: 'SVG Sweep Transition Demo',
  description:
    'Asymmetric SVG curve transition between hero and content sections.',
}

export default function SvgSweepDemoPage() {
        ...
        <Container>
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-semibold">
              Propelling these brands forward.
            </h2>
